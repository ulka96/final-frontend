  ...
  return (
      <div>
          <Container>
              ...
              <h1 className='text-[24px] md:text-[32px] lg:text-[44px] md:font-bold font-poppins font-semibold'>Accessories</h1>
              <p className='text-[#737b90] text-[14px] md:text-[18px] lg:text-[22px] text-center mt-6 '>"Add the perfect finishing touches to your home with our curated accessories collection, blending elegance and charm for every room."</p>
    ...
    <div className="py-[18px] px-8 bg-[#f8f7fb] font-bold rounded-full flex justify-center items-center w-[192px]">
    Decorative vases
    </div>
